...
<body class="login">
	...
	<div class="content">
		...
		<form class="forgetform" action='' method="post" name="frmforgetpassword" id="frmforgetpassword">
			...
			<div class="form-group">
				...
				<div class="input-icon">
					<i class="icon-user"></i>
					<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Enter Username" name="txtusername" id="txtusername"  required/>
				</div>
                
			</div>
			<div class="form-group">
				<label class="control-label visible-ie8 visible-ie9">Seurity Qestion</label>
				<div class="input-icon">
					<i class="icon-lock"></i>
					<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Enter Sequrity Question" name="txtseq" id="txtseq" required />
				</div>
               
			</div>
            <div class="form-group">
				<label class="control-label visible-ie8 visible-ie9">Answer</label>
				<div class="input-icon">
					<i class="icon-unlock"></i>
					<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Enter Answer" name="txtans" id="txtans" required />
				</div>
            ...
            <div class="btn-group">
                 <button  class="btn green" id="resetform" onclick="window.location.href='<?=base_url()?>Login/resetpassword'">Next<i class="icon-plus"></i>
                </button>
            </div>
              </div>
				
				<!--<button type="submit" class="btn green pull-right" ><a href="<?=base_url()?>Login/resetpassword" class="btn green pull-right"></a>
